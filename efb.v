...
/* Module Version: 1.2 */
/* D:\programs\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n efb -lang verilog -synth lse -bus_exp 7 -bb -type efb -arch xo2c00 -freq 96 -spi -spi_mode Slave -spi_rxr -spi_en -wb -dev 1200  */
...
module efb (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, wb_adr_i, 
    ...
    defparam EFBInst_0.EFB_WB_CLK_FREQ = "96.0" ;
    EFB EFBInst_0 (.WBCLKI(wb_clk_i), .WBRSTI(wb_rst_i), .WBCYCI(wb_cyc_i), 
        ...
        .SPICSNEN(), .SPIIRQO(spi_irq), .TCINT(), .TCOC(), .WBCUFMIRQ(), 
        .CFGWAKE(), .CFGSTDBY());
